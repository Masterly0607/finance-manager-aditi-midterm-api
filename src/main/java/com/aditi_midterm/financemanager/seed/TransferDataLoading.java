...
public class TransferDataLoading implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Transaction t1Expense = Transaction.builder()
                .account(bank)
        ...
        Transaction t1Income = Transaction.builder()
                .account(cash)
        ...
        Transaction t2Expense = Transaction.builder()
                .account(cash)
                .type(TransactionType.EXPENSE)
                .amount(new BigDecimal("100.00"))
                .note("Transfer to Bank")
        ...
        Transaction t2Income = Transaction.builder()
                .account(bank)
                .type(TransactionType.INCOME)
                .amount(new BigDecimal("100.00"))
